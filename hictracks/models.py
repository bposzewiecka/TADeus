...
from hictracks.trackPlot import PlotBed, PlotXAxis, PlotBedGraph, PlotDomains, PlotArcs, PlotHiCMatrix
...
class TrackFile(models.Model):
    ...
    def read_bed(self):
        ...
        from hictracks.readBed import BedOrBedGraphReader
...
class Track(models.Model):
    ...
    def draw_track(self, col, chrom, start, end, interval_start, interval_end, name_filter = None):
        ...
        return trackPlot.draw_track(col, chrom, start, end, interval_start, interval_end, name_filter)
