# Generated by Django 2.0.3 on 2018-07-15 14:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assembly', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chromosomes', to='hictracks.Assembly')),
            ],
        ),
        migrations.CreateModel(
            name='Eval',
            fields=[
                ...
                ('assembly', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='hictracks.Assembly')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gene', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hictracks.Gene')),
            ],
            options={
                'ordering': ['gene'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genes', models.ManyToManyField(related_name='phenotypes', through='hictracks.GeneToPhenotype', to='hictracks.Gene')),
                ('is_a', models.ManyToManyField(to='hictracks.Phenotype')),
            ],
        ),
        migrations.CreateModel(
            name='Plot',
        ...
        migrations.AddField(
            model_name='track',
            name='domains_file',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='domains_file_tracks', to='hictracks.TrackFile'),
        ),
        migrations.AddField(
            model_name='track',
            name='plot',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tracks', to='hictracks.Plot'),
        ),
        migrations.AddField(
            model_name='track',
            name='track_file',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='hictracks.TrackFile'),
        ),
        migrations.AddField(
            model_name='genetophenotype',
            name='phenotype',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hictracks.Phenotype'),
        ),
        migrations.AddField(
            model_name='gene',
            name='track_file',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gene_file_entries', to='hictracks.TrackFile'),
        ),
        migrations.AddField(
            model_name='eval',
            name='plot',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='eval', to='hictracks.Plot'),
        ),
        migrations.AddField(
            model_name='eval',
            name='track_file',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='eval', to='hictracks.TrackFile'),
        ),
        migrations.AddField(
            model_name='bedfileentry',
            name='track_file',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bedfileentry_file_entries', to='hictracks.TrackFile'),
        ),
        migrations.AddField(
            model_name='assembly',
            name='species',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='hictracks.Species'),
        ),
